...
[!DNL Adobe Analytics]분류[!UICONTROL  데이터에 대한 ] 원본 커넥터에 대한 자세한 내용은 [설명서](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/classifications.html){target="_blank"}를 참조하세요.
