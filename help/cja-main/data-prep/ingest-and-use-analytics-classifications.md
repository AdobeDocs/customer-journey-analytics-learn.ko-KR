...
description: ' [!DNL Customer Journey Analytics]에서 [!DNL Adobe Analytics] 분류 데이터를 수집하고 사용하는 방법에 대해 알아봅니다.'
...
# [!DNL Customer Journey Analytics]의 [!DNL Analysis Workspace]에서 [!DNL Adobe Analytics] 분류 데이터를 수집하고 사용합니다.
