...
맵 시각화를 통해 위치 데이터를 실감나게 표현합니다. 선택 도구를 사용하여 지역 클러스터를 식별하고 즉석에서 세그먼트를 만듭니다. 몇 가지 간단한 구성 단계만 거치면 바로 사용할 수 있습니다. 자세한 내용은 [설명서](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/map){target="_blank"}를 참조하십시오.
