...
+ 연결 {#connections}
  ...
  + [대상 분석 시작](connections/get-started-with-audience-analysis.md)
+ 방문자 식별 {#visitor-id}
  ...
  + [미리보기를 사용하여 데이터 및 결합 품질 유효성 검사](visitor-id/validate-identity-stitching-quality.md)
...
+ Data Insights 에이전트 {#data-insights-agent}
  ...
  + [Microsoft 365 Copilot과의 통합](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  ...
  + 자유 형식 테이블 {#freeform-tables}
    ...
    + [자유 형식 테이블에서 행 및 열 설정 탐색](analysis-workspace/freeform-tables/cja-explore-row-and-column-settings-in-freeform-tables.md)
  + 시각화 {#visualizations}
    ...
    + [테이블 및 시각화 데이터 소스 설정](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [라인 시각화에 추세선 추가](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [지표 스무딩에 누적 평균 함수 사용](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
    ...
    + [시각화 범례 맞춤화](analysis-workspace/visualizations/cja-customize-visualization-legends.md)
    + [시각화를 위한 세부기간 설정](analysis-workspace/visualizations/cja-set-granularity-for-visualizations.md)
  ...
  + 선별 및 공유 {#curate-and-share}
    + [데이터 스토리텔링: 슬라이드 프레젠테이션 생성](analysis-workspace/curate-and-share/data-storytelling-generate-slides.md)
...
+ 사용 사례 {#use-cases}
  + AI {#ai}
    ...
    + [Data Engineering Agent을 사용하여 데이터 세트 품질 유효성 검사](use-cases/ai/validate-dataset-quality-data-engineering-agent.md)
