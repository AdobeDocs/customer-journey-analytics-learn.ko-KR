...
+ [새 용어 및 개념](/help/new-terms-and-concepts-in-cja.md)
...
+ [데이터 보기의 구성 요소 유형 설정](/help/component-type-settings-in-data-views.md)
...
+ [크로스채널 시각화 만들기](/help/creating-cross-channel-visualizations-in-customer-journey-analytics.md)
+ [크로스채널 기여도 분석](/help/cross-channel-attribution-in-customer-journey-analytics.md)
+ [Customer Journey Analytics의 계산된 지표 소개](/help/introduction-to-calculated-metrics-in-customer-journey-analytics.md)
+ [계산된 지표를 Adobe Analytics에서 Customer Journey Analytics으로 이동](/help/moving-your-calculated-metrics-from-adobe-analytics-to-customer-journey-analytics.md)
...
+ 블루프린트 {#blueprints}
   + [Customer Journey Analytics 블루프린트](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journey-analytics/overview.html?lang=ko-KR)
